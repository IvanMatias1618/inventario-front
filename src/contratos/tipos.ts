...
export type Entidad_suprema<Crear extends object, Editar extends object, Valor extends object> = {
  crear: Crear;
  editar: Editar;
  valor: Valor;
};
...
export type Usuario = Entidad_suprema<UsuarioCrear, UsuarioEditar, UsuarioValor>;
